    ...
    return (
      <div className=" min-w-[1200px]  bg-white">
        <div className="flex h-[55px] w-full items-center space-x-2 bg-navColor">
          ...
          <div>
            <div className=" relative mr-4  flex max-h-[50px] w-auto cursor-pointer   items-center justify-center rounded-sm border border-transparent px-3 leading-none hover:border-white ">
